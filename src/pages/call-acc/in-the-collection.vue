// 催收中
<template>
  <section class="page in-the-collection">
    <data-form :model="callModle" @onSearch="refreshData" :page="pageService" :buttonWrap="true" :rules="rules" @handleResetForm="follFeedback">
      ...
      <template slot="default-input">
        ...
        <el-form-item label="客户姓名" prop="personalName" v-auth="5034">
          <el-input v-model="callModle.personalName"></el-input>
        </el-form-item>
        <el-form-item label="手机号" prop="mobileNo" v-auth="5035">
      ...
      <template slot="collapse-input">
        ...
        <el-form-item label="批次号" prop="batchNumber" v-auth="5039">
          <el-input v-model="callModle.batchNumber"></el-input>
        </el-form-item>
        <el-form-item label="机构" prop="deptCodes" v-auth="5041">
        ...
        <el-form-item label="委托方" prop="principalId" v-auth="5038">
         ...
         <el-form-item label="当前催收员" prop="collectorName" v-auth="5042">
          <el-input v-model="callModle.collectorName"></el-input>
        </el-form-item>
        <el-form-item label="协催方式" prop="assistWay" v-auth="5043">
         ...
         <div class="inline-box">
          <el-form-item label="逾期金额" prop="caseMoney" v-auth="5046">
            <number-range v-model="callModle.caseMoney"></number-range>
          </el-form-item>
        </div>
        <el-form-item label="逾期期数" prop="payStatus" v-auth="5044">
        ...
        <div class="inline-box">
          <el-form-item label="逾期天数" prop="dayRange" v-auth="5047">
            <number-range v-model="callModle.dayRange" :isInteger="true"></number-range>
          </el-form-item>
        </div>
        <el-form-item label="催收反馈" prop="follFeedbacks" v-auth="5040">
        ...
        <el-form-item label="反欺诈反馈" prop="antiFraudResult" >
         ...
         <el-form-item label="跟进时间" prop="followupTime" >
          <el-date-picker  class="daterange-large" range-separator="~" type="daterange" v-model="callModle.followupTime" placeholder="选择日期时间" clearable></el-date-picker>
        </el-form-item>
      ...
      <template slot="default-button">
        <!--按钮区域-->
        <el-button @click="batchClick" v-auth="5048" >批量分配</el-button>
        <!-- <el-button @click="leaveCaseClick" v-auth="5049">留案</el-button> -->
        <!-- <el-button @click="cancleleaveCase" v-auth="5050">取消留案</el-button> -->
        <!-- <el-button @click="applyFlowClick" v-auth="5051">提前流转</el-button> -->
        <el-button @click="circulationClick" v-auth="5051">申请流转</el-button>
      ...
      <template slot="columns">
        ...
        <el-table-column label="操作" :min-width="$helper.getColumnWidth(6)">
          <template slot-scope="scope">
            <el-button @click="phoneRecord(scope)" type="text" v-auth="5052">电话录音</el-button>
            <el-button @click="repair=scope.row,dialog.FollowRecord=true" type="text" v-auth="5053">跟进明细</el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog title="批量分配" :visible.sync="dialog.disabled" @open="loadData" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false">
      <MassDistribution @close="dialog.disabled=false" @refresh="refreshData" ref="refresh" :typeId="typeId" :selectionList="selectionList"></MassDistribution>
    </el-dialog>
