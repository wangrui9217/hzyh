<template>
  <!-- 停催案件管理-待分配案件 --> 
  <section class="page stop-undistributed-case">
    <data-form :model="searchModel" @onSearch="refreshData" :page="pageService" :rules="searchRule">
      ...
      <template slot="default-button">
        <el-button @click="caseAllotClick">手动分配</el-button>
    ...
    <el-dialog title="请选择催收员" :center="true" :visible.sync="dialog.caseAllot" width="80%">
      <case-allot :modelType="[506]" ref="case-allot" @close="dialog.caseAllot = false" @success="refreshData();dialog.caseAllot = false"></case-allot>
    </el-dialog>
    <!-- 跟进记录 -->
...
export default class StopUndistributedCase extends Vue {
  ...
  @stopCaseModule.Mutation updateWaitStopCase;
