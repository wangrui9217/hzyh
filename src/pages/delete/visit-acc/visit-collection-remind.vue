<template>
  <section class="page visit-collection-remind">
    <data-form :model="callModle" @onSearch="refreshData" :page="pageService" :rules="rules" @handleResetForm="follFeedback">
      ...
      <template slot="default-input">
        ...
        <el-form-item label="客户姓名" prop="personalName" v-auth="1257">
          <el-input v-model="callModle.personalName"></el-input>
        </el-form-item>
        <el-form-item label="手机号" prop="mobileNo" v-auth="1258">
          <el-input v-model="callModle.mobileNo" :maxlength="13"></el-input>
        </el-form-item>
      </template>
      <template slot="collapse-input">
        <el-form-item label="案件状态" prop="collectionStatus" v-auth="1262">
        ...
        <el-form-item label="案件标记" prop="caseMark" v-auth="1266">
        ...
        <el-form-item label="催收反馈" prop="follFeedbacks" v-auth="1268">
        ...
        <el-form-item label="机构" prop="deptCodes" v-auth="1259">
        ...
        <el-form-item label="当前催收员" prop="collectorId" v-auth="1260">
          <el-input v-model="callModle.collectorId"></el-input>
        </el-form-item>
        <el-form-item prop="idCard" label="身份证号" v-auth="1264">
          <el-input v-model="callModle.idCard"></el-input>
        </el-form-item>
        <div class="inline-box">
          <el-form-item label="逾期金额" prop="caseMoney" v-auth="1261">
            <number-range v-model="callModle.caseMoney"></number-range>
          </el-form-item>
        </div>
        <div class="inline-box">
          <el-form-item label="逾期天数" prop="dayRange" v-auth="1263">
    ...
    <data-box :data="callAccDataSet" :rowClass="rowClass" :selectionList.sync="selectionList" @onPageChange="refreshData" :sort="sortService" :page="pageService" ref="data-box">
      <template slot="columns">
        ...
        <el-table-column prop="overdueAmount" label="逾期金额(元)" sortable='custom' :min-width="$helper.getColumnWidth(4)" align="right">
          <template slot-scope="scope">
        ...
        <el-table-column prop="mixCollectorName" label="电话催收员" :min-width="$helper.getColumnWidth(4)" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="collectorName" label="外访催收员" :min-width="$helper.getColumnWidth(4)" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column prop="caseFollowInTime" sortable='custom' label="案件流入日期" :min-width="$helper.getColumnWidth(4)">
          <template slot-scope="scope">
        ...
        <el-table-column prop="employeeRealName" label="业务经理" :min-width="$helper.getColumnWidth(5)" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column label="操作" :min-width="$helper.getColumnWidth(6)">
          <template slot-scope="scope">
            <el-button @click="hangClick(scope)" type="text" v-if="scope.row.handUpFlag === 52">挂起</el-button>
            <el-button @click="unhangClick(scope)" type="text" v-if="scope.row.handUpFlag === 53">取消挂起</el-button>
            <el-button @click="repair=scope.row,dialog.FollowRecord=true" type="text" v-auth="1269">跟进明细</el-button>
          </template>
        </el-table-column>
      </template>
    </data-box>
...
export default class VisitCollectionRemind extends Vue {
